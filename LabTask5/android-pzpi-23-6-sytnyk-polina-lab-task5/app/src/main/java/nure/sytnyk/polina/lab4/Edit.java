...
public class Edit extends AppCompatActivity {
    ...
    private void openImagePicker() {
        // Логика выбора изображения, например через Intent
    ...
    private void saveNote() {
        ...
        int newImportance = importanceSpinner.getSelectedItemPosition() + 1; // Получаем индекс, прибавляем 1, так как индексы начинаются с 0
        String newDateTime = System.currentTimeMillis() + "";  // Пример получения текущего времени в строковом формате
